...
All notable changes to the OpenClaw KeeperHub plugin (`openclaw-plugins/keeperHub`) are documented here.
...
Subpath in repo: `openclaw-plugins/keeperHub`
...
[1.0.1]: https://github.com/Bleyle823/Keepers-Eliza-Plugin/tree/7504425ad423952966a025869961f100d3f065c5/openclaw-plugins/keeperHub
...
- Initial OpenClaw plugin release mirroring the Eliza `plugin-keeperHub` surface.
...
- Config via `plugins.entries.keeperHub.config.apiKey` or `KH_API_KEY` / `KEEPERHUB_API_KEY`.

[1.0.0]: https://github.com/Bleyle823/Keepers-Eliza-Plugin/tree/ab96c89/openclaw-plugins/keeperHub
